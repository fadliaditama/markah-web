...
const CardListClass = ({ img, to, name, desc }) => {
  return (
    <section className="py-5 px-0">
      <div className="flex flex-col justify-between bg-white w-80 h-100 mx-0 shadow-lg border-gray-700 rounded-lg border-2">
        <div className="flex flex-row space-x-7 mx-14 p-5 py-10">
          <img
        ...
        <div>
          <h5 className="text-gray-400 font-semibold mt-0 ml-5 ">- {desc} </h5>
        </div>
        <div className="flex flex-col items-center p-5">
          <Link to={to} className="bg-red-700 p-3 hover:bg-red-900 text-center text-white w-36 rounded-md font-semibold">
